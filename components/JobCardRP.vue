...
<!-- <a :href="'/jobview/' + id"> -->
    <div v-motion-slide-visible-once-bottom class="justify-center flex mb-2 cursor-pointer" @click="visible = true">
  ...
  <!-- Calendar Icon -->
  <svg class="ml-4 sm:flex hidden" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 20" fill="none">
