...
<div
  class="flex flex-col bg-clip-border rounded-xl bg-darkGrey border-gray-300 text-white shadow-gray-900/20 shadow-md w-full max-w-[20rem] p-8">
  <div
    ...
    <h1 class="flex justify-center gap-1 mt-6 font-sans antialiased font-normal tracking-normal text-white text-7xl">
      <span class="mt-2 text-4xl">€</span>{{ price }}
