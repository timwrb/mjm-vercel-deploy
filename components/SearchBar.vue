...
<template>
     <div class="flex flex-col">
      <div class="flex flex-col md:flex-row lg:gap-[2.625rem] gap-[1rem]">
  
    <label class="input input-bordered flex items-center gap-2 xl:w-[31.25rem] lg:w-[22.5rem] w-[20rem] h-[3.5rem] rounded-full">
    ...
    <input type="text" class="grow outline-none" v-model="searchTerm" placeholder="Jobtitel, Branche, ..."/>
    </label>

<label class="input input-bordered flex items-center gap-2 xl:w-[21.25rem] lg:w-[15.625rem] w-[20rem] h-[3.5rem] rounded-full">
  ...
  <input type="text" class="grow outline-none" placeholder="Stadt, PLZ..."/>
</label>
  ...
  <div class="hidden lg:flex">
    ...
    Stelle finden
        ...
        <div class="lg:hidden flex justify-center mt-[2rem] w-full">
    <NuxtLink :to="`/search/${searchTerm}`" class="btn btn-default bg-almostBlack hover:bg-almostBlack text-almostWhite font-medium text-[1.25rem] rounded-3xl w-[13.438rem] h-[3rem] justify-center cursor-pointer select-none flex items-center hover:opacity-80">
    Stelle finden
    </NuxtLink>
        </div>
      </div>
