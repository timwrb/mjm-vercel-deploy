...
<label v-tooltip.top="'Stadt eingeben'" class="input input-bordered flex items-center gap-2 xl:w-[21.25rem] lg:w-[15.625rem] sm:w-[19rem] w-[16rem] sm:h-[3.5rem] h-[2.5rem] rounded-full">
  ...
  <div class="hidden lg:flex">
    ...
    class="btn btn-default bg-almostBlack hover:bg-almostBlack text-almostWhite font-medium text-[1.25rem] rounded-full w-[13.438rem] sm:h-[3.5rem] h-[2.5rem] justify-center cursor-pointer select-none flex items-center hover:opacity-80">
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
